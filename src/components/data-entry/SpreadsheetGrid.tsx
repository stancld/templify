        ...
        <div className="flex min-h-full min-w-max flex-col">
          ...
          {rows.length > 0 && (
            <button
              type="button"
              onClick={onAddRow}
              className="flex-1 min-h-[96px] border-t border-dashed border-neutral-gray/20 px-4 py-6 text-left text-sm text-neutral-gray transition-colors hover:bg-primary/5 hover:text-primary"
            >
